...
---
source: https://help.aliyun.com/zh/yunxiao/developer-reference/getmember-query-member-information
category: organization
downloaded_at: 2026-01-26T14:42:31.477135
---
...
| id             | string | path | 是    | 组织成员 ID。 | 3a41****3eca |

## 请求示例

```
curl -X 'GET' \
  'https://test.rdc.aliyuncs.com/oapi/v1/platform/organizations/{organizationId}/members/{id}' \
