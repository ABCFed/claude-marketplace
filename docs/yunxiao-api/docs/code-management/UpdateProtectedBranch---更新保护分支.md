...
---
source: https://help.aliyun.com/zh/yunxiao/developer-reference/updateprotectedbranch
category: code-management
downloaded_at: 2026-01-26T14:35:11.018127
---
...
| allowMergeUserIds                   | array[string]  | body | 否    | 允许合并的用户 ID 列表。                                 | 62c795c9cf*****b468af8   |
| allowPushRoles                      | array[integer] | body | 否    | 允许推送的角色列表：40-管理员，30-开发者。                       | 40                       |
| allowPushUserIds                    | array[string]  | body | 否    | 允许推送用户 ID 列表。                                  | 62c795c9cf*****b468af8   |
| branch                              | string         | body | 否    | 被保护分支名称。                                       | protectedBranch          |
| mergeRequestSetting                 | object         | body | 否    | 要求合并前通过代码评审。                                   |                          |
| allowMergeRequestRoles              | array[integer] | body | 否    | 允许合并请求的角色列表。                                   | 30                       |
| defaultAssignees                    | array[string]  | body | 否    | 默认评审人 ID 列表。                                   | 62c795c9cf*****b468af8   |
...
| -                                   | object         | body | 否    |                                                |                          |
| id                                  | string         | body | 否    | 写入人的 ID。                                       | 62c795c9cf*****b468af8   |
...
| taskName                            | string         | body | 否    | 检测任务名称。                                        | biz-task-quality         |
...
| allowMergeUserIds                   | array[string]  | 允许合并的用户 ID 列表。                                       | 62c795c9cf*****b468af8                                                             |
...
| allowPushUserIds                    | array[string]  | 允许推送用户 ID 列表。                                        | 62c795c9cf*****b468af8                                                             |
...
| -                                   | object         |                                                      |                                                                                    |
| id                                  | string         | 写入人的 ID。                                             | 62c795c9cf*****b468af8                                                             |
