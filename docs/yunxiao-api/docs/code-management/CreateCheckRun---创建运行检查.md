...
---
source: https://help.aliyun.com/zh/yunxiao/developer-reference/createcheckrun
category: code-management
downloaded_at: 2026-01-26T14:36:28.442740
---
...
| endColumn       | integer | body | 否    | 结束列，当且仅当 startLine=endLine 时，该字段值有效。                                                                                                              | 5                                        |
...
| headSha         | string  | body | 否    | 提交 ID，但需要确保该提交 ID 是某个新版合并请求的合并源。                                                                                                                  | 40f4ccfe019cdd4a62d4acb0c57130106fc7e1be |
...
```
curl -X 'POST' \
  'https://test.rdc.aliyuncs.com/oapi/v1/codeup/organizations/{organizationId}/repositories/{repositoryId}/checkRuns' \
...
| endColumn       | integer | 结束列，当且仅当 startLine=endLine 时，该字段值有效。                                                                   | 5                                        |
| endLine         | integer | 结束行。                                                                                                   | 2                                        |
| id              | integer | 检查注解 ID，唯一标识。                                                                                          | 524836                                   |
| message         | string  | 摘要信息。                                                                                                  | ""                                       |
...
| createdAt       | string  | 回写记录的创建时间。                                                                                             | 2022-01-14T21:08:26+08:00                |
