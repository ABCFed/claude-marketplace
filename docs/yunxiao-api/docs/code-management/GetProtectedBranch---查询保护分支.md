# GetProtectedBranch - 查询保护分支

---
source: https://help.aliyun.com/zh/yunxiao/developer-reference/getprotectedbranch
category: code-management
downloaded_at: 2026-01-26T14:34:57.965509
---
...
```
GET https://{domain}/oapi/v1/codeup/organizations/{organizationId}/repositories/{repositoryId}/protectedBranches/{id}
```
