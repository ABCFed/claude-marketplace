...
---
source: https://help.aliyun.com/zh/yunxiao/developer-reference/createchangerequestcomment
category: code-management
downloaded_at: 2026-01-26T14:36:10.307603
---
...
| -                     | object  | body | 否    |                                                                                |                                              |
| comment_type          | string  | body | 是    | 评论类型。                                                                          | GLOBAL_COMMENT,INLINE_COMMENT                |
| content               | string  | body | 是    | 评论内容，长度必须在 1 到 65535 之间。                                                       | This is a comment content.                   |
| draft                 | boolean | body | 是    | 是否草稿评论。                                                                        | true                                         |
| file_path             | string  | body | 否    | 文件名称，只有行内评论才有。                                                                 | /src/main/java/com/example/MyClass.java      |
| from_patchset_biz_id  | string  | body | 否    | 比较的起始版本 id，INLINE_COMMENT 类型的评论必传。                                             | bf117304dfe44d5d9b1132f348edf92e             |
| line_number           | integer | body | 否    | 行号，只有行内评论才有。                                                                   | 42                                           |
| parent_comment_biz_id | string  | body | 否    | 父评论 id。                                                                        | 12345                                        |
| patchset_biz_id       | string  | body | 是    | 关联版本 id，如果是 INLINE_COMMENT，则选择 from_patchset_biz_id 或 to_patchset_biz_id 中的一个。 | bf117304dfe44d5d9b1132f348edf92e             |
| resolved              | boolean | body | 是    | 是否标记已解决。                                                                       | false                                        |
| to_patchset_biz_id    | string  | body | 否    | 比较的目标版本 id， INLINE_COMMENT 类型的评论必传。                                            | bf117304dfe44d5d9b1132f348edf92e             |
...
| userId                           | string  | 云效用户 ID。                                      | 62c795xxxb468af8                         |
| username                         | string  | 用户登录名。                                        | codeup-username                          |
| comment_biz_id                   | string  | 评论 bizId。                                     | bf117304dfe44d5d9b1132f348edf92e         |
